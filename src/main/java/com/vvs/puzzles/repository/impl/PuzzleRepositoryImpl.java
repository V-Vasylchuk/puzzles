package com.vvs.puzzles.repository.impl;

import com.vvs.puzzles.exeption.RepositoryException;
...
public class PuzzleRepositoryImpl implements PuzzleRepository {
    ...
    public String savePuzzle(String imageName,
        ...
        if (getAllPuzzles().contains(imageName)) {
            throw new RepositoryException("Puzzle with this name is already saved!");
        }
        ...
        try {
            ...
            throw new RepositoryException("Failed to write original"
        ...
        for (int i = 0; i < tileImages.length; i++) {
            ...
            try {
                ...
                throw new RepositoryException("Failed to write tile "
                        + "image file to repository!", e);
            }
        }
    ...
    public String saveSolution(BufferedImage solution) {
        ...
        try {
            ...
            throw new RepositoryException("Failed to save solution image", e);
        }
        return path;
    }
